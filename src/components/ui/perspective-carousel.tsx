              ...
              >
                ...
                >
                  <button
                    ...
                    className="aspect-square w-full cursor-pointer flex items-center justify-center"
                  ...
                  >
                    ...
                    <img
                      ...
                      draggable={false}
                      className={cn(
                        "h-full w-full select-none rounded-full object-cover shadow-xl border-2 border-border/70",
                        imageClassName
                      )}
                    />
                  </button>
                  ...
                  <motion.div
                    className={cn("flex flex-col items-center text-center", labelClassName)}
                    animate={{
                  ...
                  >
                    ...
                    {item.subtitle && (
                      <p className="whitespace-nowrap text-[11px] text-muted-foreground mt-0.5">
                        {item.subtitle}
                      </p>
                    )}
                  </motion.div>
